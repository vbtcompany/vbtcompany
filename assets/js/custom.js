...
var policyToggleVal = 'off';
function togglePolicy() {
  if(policyToggleVal == 'off'){
    $("#policyContainerMain").removeClass('d-none');
    policyToggleVal = 'on';
  } else {
    $("#policyContainerMain").addClass('d-none');
    policyToggleVal = 'off';
  }
}

// $('#policyContainerMain').on('click', ()=> {
//   togglePolicy()
// })

window.addEventListener('click', function(e){   
  if (document.getElementById('policyContainerMain').contains(e.target) && !document.getElementById('policyContainer').contains(e.target)){
    // Clicked in box
  togglePolicy()
...
var lightTheme = {
  ...
  dark_bg_trans_main: '#00000098',
  dark_bg_trans: '#000000c1',
  call_back_btn_color: '#1e90ff',
};
